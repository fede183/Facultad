...
public:
    ...
    Lista<compu> CaminoRecorrido(const paquete&); //para mi debería ser const al final la función, pero me parece que la implementación que usaron cambia la estructura.
