...
//Este test consiste basicamente en agregar elementos a la cola de prioridad e ir pasando unos test a la par que se muestran los
...
void avl_test(){
  DiccNat<Nat> avl1, avl2, avl3, avl4;    //Creamos los avl vacios. Cada uno para poder observar todos los casos de rebalanceo.

  //Para cada uno de los casos lo que hacemos es definir unas claves en un determinado orden para poder ver los distintos casos de
  //rebalanceo. Cada vez que lo hacemos nos aseguramos que el arbol este, en efencto, balanceado. Despues revisamos que el arbol 
  //tenga definidas todas las claves y que cada una le corresponda el significado correcto.
