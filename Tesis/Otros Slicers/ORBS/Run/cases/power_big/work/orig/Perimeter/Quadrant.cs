...
{
	public static Quadrant cNorthWest = new NorthWest();
	public static Quadrant cNorthEast = new NorthEast();
	public static Quadrant cSouthWest = new SouthWest();
	public static Quadrant cSouthEast = new SouthEast();
