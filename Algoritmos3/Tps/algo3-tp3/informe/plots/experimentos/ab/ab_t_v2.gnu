...
plot 'ab_busquedaLocal_v2_s0.out' using 3:6 smooth bezier lw 2 lc 1 title 'Vecindario 2: Primer color', \
	'' u 3:6 with points pt 2 lc 1 title '', \
'ab_busquedaLocal_v2_s2.out' using 3:6 smooth bezier lw 2 lc 2 title 'Vecindario 2: Colores random', \
